...
<strong>2.2.-</strong> Los USUARIOS, a través de colaboraciones o introducción voluntaria de contenidos,  tanto gráficos como escritos, directa o indirectamente a través de enlaces o links siendo éstos los únicos responsables de los mismos y quedando expresamente exento EL PROPIETARIO de toda responsabilidad. EL USUARIO que introduzca cualquier contenido en el sitio web del PROPIETARIO manifiesta la absoluta legalidad y autoría de los mismos y expresamente asume todo tipo de responsabilidad que se pueda derivar de estos contenidos. El USUARIO también se hace responsable de las opiniones introducidas en el chat y foros puestos a su disposición en el sitio web. EL PROPIETARIO no será responsable en ningún caso de las opiniones vertidas en los referidos foros y podrá retirar o impedir el acceso a los USUARIOS que vulneren la legalidad vigente así como poner en conocimiento de Juzgados y Tribunales los hechos que sean constitutivos de algún tipo de ilícito penal o civil.
